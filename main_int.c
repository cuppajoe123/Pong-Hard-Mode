...
int main(void)
{
    ...
    /* IMPORTANT: Use a struct for x_pos and y_pos, instead of 2 variables */
    ...
    int left_pad_x_pos = (int)(WINDOW_WIDTH - (WINDOW_WIDTH - 10));
    int left_pad_y_pos = (int)(WINDOW_HEIGHT - left_pad.h) / 2;
    ...
    int right_pad_x_pos = (int)(WINDOW_WIDTH - 10);
    int right_pad_y_pos = (int)(WINDOW_HEIGHT - left_pad.h) / 2;
    // set the positions in the struct
    ...
    ball1.w /= 10;
    ball1.h /= 10;
    int ball1_x_pos = (int)(WINDOW_WIDTH) / 2;
    int ball1_y_pos = (int)(WINDOW_HEIGHT) / 2;
    ...
    ball2.w /= 10;
    ball2.h /= 10;
    int ball2_x_pos = (int)(WINDOW_WIDTH) / 2;
    int ball2_y_pos = (int)(WINDOW_HEIGHT) / 2;
